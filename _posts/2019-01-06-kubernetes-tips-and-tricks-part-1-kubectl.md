...
Among other things, it will autocomplete resource kinds and object names for you, which
can be especially useful for objects with autogenerated names, such as `Pod`s.
